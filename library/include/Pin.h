...
class UPinComponent : public IComponent
{
...
public:
	...
	{
		m_OutputBitset.setAll(m_InputBitset[0]);
	}
...
public:
	virtual ~UPinComponent( ) = default;

private:
	TBitset<UPinComponent::s_InputCount> m_InputBitset;
	TBitset<UPinComponent::s_OutputCount> m_OutputBitset;
};

typedef UPinComponent UOutPinComponent;
typedef UPinComponent UInPinComponent;
