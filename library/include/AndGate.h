...
class UAndGateComponent : public IComponent
{
...
public:
	virtual ~UAndGateComponent( ) = default;

private:
	TBitset<UAndGateComponent::s_InputCount> m_InputBitset;
	TBitset<UAndGateComponent::s_OutputCount> m_OutputBitset;
};
