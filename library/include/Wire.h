...
class UWireComponent : public IComponent
{
	static constexpr size_t s_InputCount = 1U;
	static constexpr size_t s_OutputCount = 10U;
public:
...
public:
	virtual ~UWireComponent( ) = default;

private:
	TBitset<UWireComponent::s_InputCount> m_InputBitset;
	TBitset<UWireComponent::s_OutputCount> m_OutputBitset;
};
