...
class UOrGateComponent : public IComponent
{
...
public:
	virtual ~UOrGateComponent( ) = default;

private:
	TBitset<UOrGateComponent::s_InputCount> m_InputBitset;
	TBitset<UOrGateComponent::s_OutputCount> m_OutputBitset;
};
